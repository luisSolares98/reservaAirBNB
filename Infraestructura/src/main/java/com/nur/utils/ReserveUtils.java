...
public class ReserveUtils {
	...
	public static List<ReserveJpaModel> reserveJpaModelList(List<Reserve> reservas) {
		if (reservas == null)
			return Collections.emptyList();
		return reservas.stream().map((Reserve reserva) -> reservaToJpaEntity(reserva)).toList();
	}
	...
	public static Reserve jpaToreserva(ReserveJpaModel jpaModel) throws BussinessRuleValidationException {
		if (jpaModel == null) {
