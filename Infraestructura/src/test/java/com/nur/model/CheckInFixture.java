...
public class CheckInFixture {
	...
	public static List<CheckInJapModel> whitDefaultListJPA() throws BussinessRuleValidationException, ParseException {
		return Arrays.asList(new CheckInJapModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"),
				UtilTest.parseToDate("2022-05-21"), UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), "Digital"),
				new CheckInJapModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"),
