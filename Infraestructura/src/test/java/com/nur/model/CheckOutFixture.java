...
public class CheckOutFixture {
	...
	public static List<CheckOutJapModel> whitDefaultListJPA() throws BussinessRuleValidationException, ParseException {
		return Arrays.asList(new CheckOutJapModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"),
				UtilTest.parseToDate("2022-05-21"), UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), "Digital"),
				new CheckOutJapModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"),
						UtilTest.parseToDate("2022-05-21"), UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"),
						"Digital"));
	}
