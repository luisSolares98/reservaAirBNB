...
public class ReserveFixture {
    ...
    public static List<ReserveJpaModel> whitDefaultListJPA() throws BussinessRuleValidationException, ParseException {
        return Arrays.asList(new ReserveJpaModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), UtilTest.parseToDate("2022-05-21"),  UtilTest.parseToDate("2022-05-29"), "Realizada", UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c28")), new ReserveJpaModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), UtilTest.parseToDate("2022-05-21"), UtilTest.parseToDate("2022-05-29"), "Realizada", UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c29")));
    }
